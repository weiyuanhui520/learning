...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("进入了第一个聊天窗口")
        # 判断聊天窗是否是公众号
        is_weichat = is_element_exist(driver, "com.tencent.mm:id/u1")
        if is_weichat == True:
            print()
            # while True:
            # 有红包则点击
            ...
            # 判断红包是否被领取
            time.sleep(1)
            is_open = is_element_exist(driver, "com.tencent.mm:id/f4f")
            ...
            if is_open == True:
                ...
                print('已经领取红包')
                is_open2 = is_element_exist(driver, "com.tencent.mm:id/ei")
                if is_open == True:
